angular.module('expoinga.app.controllers', [])
...
.controller('FeedCtrl', function($scope, $ionicModal, PostService) {
  
   $ionicModal.fromTemplateUrl('views/app/legal/camera.html', {
    scope: $scope,
    animation: 'slide-in-up'
  }).then(function(modal) {
    $scope.opencamera = modal;
  });

  $scope.showTerms = function() {
    $scope.opencamera.show();
  };
...
//app.controller('EntradaCtrl', function($http) {
//  var _this = this
//  this.items = []

//  $http.get('http://www.expoinga.com.br/restrito/api/paginas.php?tipo=pagina&user=4').then(function(data) {
