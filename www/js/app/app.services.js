angular.module('expoinga.app.services', [])
...
.service('ShopService', function ($http, $q, _){
  ...
  this.getProducts = function(){
    var dfd = $q.defer();
    $http.get('http://www.expoinga.com.br/restrito/api/paginas.php?tipo=pagina&user=4').success(function(database) {
      dfd.resolve(database.banana);
    });
    return dfd.promise;
  };
